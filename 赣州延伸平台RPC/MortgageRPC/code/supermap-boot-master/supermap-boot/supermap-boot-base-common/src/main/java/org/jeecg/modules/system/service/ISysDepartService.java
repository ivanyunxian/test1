...
public interface ISysDepartService extends IService<SysDepart>{
    ...
    List<SysDepartTreeModel> queryTreeList(String deptId);

    /**
     * 根据当前部门id查询该部门及子部门,并分节点进行显示
     * @return
     */
    List<SysDepartTreeModel> queryDepartById(String deptId);
    ...
    List<SysDepartTreeModel> searhBy(String keyWord, String deptId);
