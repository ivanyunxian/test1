...
public class SysUserCacheInfo {
	...
	private List<String> sysMultiDeptId;
	...
	public List<String> getSysMultiDeptId() {
		return sysMultiDeptId;
	}

	public void setSysMultiDeptId(List<String> sysMultiDeptId) {
		this.sysMultiDeptId = sysMultiDeptId;
	}
}
