...
public class ConstValue {
	 ...
	 */
	public enum SQRLB {
		JF("1", "甲方"), YF("2", "乙方"), BF("3", "丙方"), FQF("4", "放弃方"),LHGXF("5","利害关系方"),DYQR("10","抵押权人");
	...
	public enum SFZT {
		...
		private SFZT(String value) {
			this.Value = value;
		}

		private SFZT(String value, String name) {
			this.Value = value;
			this.Name = name;
		}
