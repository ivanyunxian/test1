...
public class SysDepart implements Serializable {
	...
	@Dict(dicCode = "DEPT_TYPE")
	private String deptType;
	/**机构/部门名称*/
	@Excel(name="区划代码/机构区划",width=15)
	...
	/**法人证件号*/
	@Excel(name="法人证件号",width=15)
	private String fddbrzjhm;
	//金融机构等第三方提供的结果回写接口授权token
	private String token;
	//token 有效时间
	private Date validtime;
	//机构接口配置代码，对应CoreAPI里配置文件的对应配置，实现不同机构使用不同配置的目的
	private String jgdm;
	//企业机构部门ID
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, depart.id) &&
				...
				Objects.equals(fddbr, depart.fddbr)&&
				Objects.equals(fddbrzjlx, depart.fddbrzjlx)&&
				Objects.equals(fddbrzjhm, depart.fddbrzjhm);
    }
    ...
    public int hashCode() {
        ...
        return Objects.hash(super.hashCode(), id, parentId, departName, 
        		...
        		delFlag, createBy, createTime, updateBy, updateTime,fddbr,fddbrzjlx,fddbrzjhm);
    }
}
