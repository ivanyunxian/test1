...
//     } 
     ...
     * @throws Exception
     */
    public static String encryptByPrivateKeyBase64CatchExcetion(String data){
        try {
            return encode(encryptByPrivateKey(data.toString()));
        } catch (Exception e) {
            e.printStackTrace();
            return "生成密文出错，请联系管理员排查";
        }
    }
    /**公钥解密且BASE64解码
     * @param data
     ...
     * @return
     */
    public static String decryptRequest(String requestJson){
        try {
            return decryptByPrivateKeyBase64(requestJson);
        } catch (Exception e) {
            e.printStackTrace();
            return ConstValueMrpc.MrpccodingEnum.FAIL.Value;
        }
    }
     ...
     * @param extraDate
     *            额外的值
     * @param bz 除了固定的msg外的提示消息
     * @return
     */
    public static String resultsJson(String code, String requestcode, Object queryResultsDate, Object extraDate,String bz) {
        JSONObject resultsJson = new JSONObject(6);
        resultsJson.put("code", code);
        resultsJson.put("msg", ConstValueMrpc.MrpccodingEnum.initFrom(code).Name+bz);
        ...
        try {
            return encryptByPrivateKeyBase64(resultsJson.toString());
        } catch (Exception e) {
            e.printStackTrace();
            try {
     ...
     * @return
     */
    public static String resultsJsonNoRsa(String code, String requestcode, Object queryResultsDate, Object extraDate) {
        JSONObject resultsJson = new JSONObject(6);
        resultsJson.put("code", code);
