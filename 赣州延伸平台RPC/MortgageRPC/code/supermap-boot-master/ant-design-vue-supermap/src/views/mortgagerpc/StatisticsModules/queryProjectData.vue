    ...
    <div class="table-page-search-wrapper">
      ...
      <!--   <a-col :md="6" :sm="8">
            <a-form-item
              ...
              label="市">
              <j-dict-select-tag
                @change="handleChangeRuleCondition"  v-decorator="['city', {}]"
                placeholder="请选择城市" :triggerChange="true"  dictCode="DIVISION_CODE" />
            </a-form-item>
          </a-col>
          ...
          <a-col :md="6" :sm="8">
            <a-form-item
              ...
              label="区">
              <j-dict-select-tag
                @change="handleChangeRuleCondition"  v-decorator="['area', {}]"
          ...
          <a-Col :md="6" :sm="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="项目名称">
              <a-input placeholder="请输入项目名称"  id="xmmc"  />
            </a-form-item>
          </a-Col>
  ...
  export default {
    ...
    methods: {
      ShowProjectData(d){
        ...
        //通过ID直接获取输入类型参数
        if(document.getElementById("xmmc").value != ""){
          this.params['xmmc'] = document.getElementById("xmmc").value;
        }
