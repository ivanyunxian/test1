<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="参数值">
              <a-input placeholder="请输入参数值" v-model="queryParam.value"></a-input>
            </a-form-item>
          </a-col>
         ...
         <!-- <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="类型">
              <j-dict-select-tag  placeholder="请选择参数类型" v-model="queryParam.type" dictCode="CSLX" />
            </a-form-item>
          </a-col>
         <!-- <a-col :md="6" :sm="8">
    ...
    <!-- 表单区域 -->
    <sys_config-modal ref="modalForm" @ok="modalFormOk"></sys_config-modal>
  </a-card>
</template>

<script>
  import Sys_configModal from './modules/Sys_configModal'
