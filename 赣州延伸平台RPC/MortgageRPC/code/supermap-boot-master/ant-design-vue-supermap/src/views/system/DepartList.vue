    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          ...
          <a-button @click="handleAdd(1)" type="primary" v-has="'level1:add'">添加一级部门</a-button>
      ...
      <a-card :bordered="false">
        <a-form :form="form">
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="法人证件类型">
            <a-select placeholder="请选择部门证件类型" v-decorator="[ 'fddbrzjlx', {'initialValue':''}]"  >
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="机构接口类型">
            <j-dict-select-tag v-decorator="['jgdm', {}]"
                               placeholder="机构接口类型" :triggerChange="true" dictCode="JGDM"/>
          </a-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          ...
          mobile: {rules: [{required: true, message: '请输入部门联系方式!', validator: this.validateMobile}]}
        },
        url: {
    ...
    methods: {
      ...
      setValuesToForm(record) {
        ...
        this.form.setFieldsValue(pick(record,'deptZjlx','deptZjh', 'deptType','divisionCode','departName', 'orgCode', 'departOrder', 'mobile', 'fax', 'address', 'memo','fddbrzjhm','fddbrzjlx','fddbr','jgdm'))
      },
