  ...
  <a-card :bordered="false">
    ...
    <div>
      <a-tabs defaultActiveKey="1" @change="callback">
        ...
        <a-tab-pane tab="接口日志" key="3"></a-tab-pane>
      </a-tabs>
    </div>
    ...
    <a-table
      ...
      <div v-show="queryParam.logType==3" slot="expandedRowRender" slot-scope="record" style="margin: 0">
        <div style="margin-bottom: 5px"><a-badge status="success" style="vertical-align: middle;"/><span style="vertical-align: middle;">请求方法:{{ record.method }}</span></div>
        <div><a-badge status="processing" style="vertical-align: middle;"/><span style="vertical-align: middle;">请求参数:{{ record.requestParam }}</span></div>
        <div><a-badge status="processing" style="vertical-align: middle;"/><span style="vertical-align: middle;">返回状态:{{ record.resultstate }}</span></div>
        <div><a-badge status="processing" style="vertical-align: middle;"/><span style="vertical-align: middle;">返回报文:{{ record.responsedata }}</span></div>
      </div>
