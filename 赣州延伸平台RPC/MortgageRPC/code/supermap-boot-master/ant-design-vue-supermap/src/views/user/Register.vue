<template>
  <div class="main user-layout-register">
    <h3 style="width: 400px;margin-left: 400px;"><span>注册</span></h3>
    <a-form ref="formRegister" :autoFormCreate="(form)=>{this.form = form}" id="formRegister" style="width: 400px;margin-left: 400px;">
      <a-form-item
      ...
      <a-form-item
        fieldDecoratorId="zjlx"
        :fieldDecoratorOptions="{rules: [{ required: true, message: '请选择证件类型'}], validateTrigger: ['change', 'blur']}">
      ...
      <a-form-item
        fieldDecoratorId="zjh"
        :fieldDecoratorOptions="{rules: [{ required: true, message: '证件号不能为空'}], validateTrigger: ['change', 'blur']}">
        <a-input size="large" type="text" autocomplete="false" placeholder="请输入证件号"></a-input>
      </a-form-item>
