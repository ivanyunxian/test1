<template>
  <div class="main">
    <a-form :form="form" class="user-layout-login" ref="formLogin" id="formLogin"  style="width: 400px;margin-left: 450px;margin-top: 65px;">
      <a-tabs
        ...
        <a-tab-pane key="tab1" tab="账号密码登陆">
          ...
          <a-form-item>
                    ...
                    <a style="float:right;margin-left:20px;" type="primary" @click="filedownload">驱动下载</a>
      ...
      <a-form-item>
        ...
        <a style="float:right;margin-left:20px;" type="primary" @click="linkTo('/enterprise/list')">
          企业驳回查询
        </a>
        <a style="float:right;" type="primary" @click="linkTo('/enterprise/apply')">
          企业注册申请
        </a>
      </a-form-item>
...
<script>
  ...
  import {socketload} from '@/utils/socket.js';
...
//        })
    ...
    methods: {
      ...
      filedownload(){
        ...
        axios({
          ...
          if (typeof window.navigator.msSaveBlob !== 'undefined') {
              ...
              link.href = url
              link.setAttribute('download',  "驱动.rar")
        ...
        if (that.customActiveKey === 'tab1') {
          that.form.validateFields([ 'username', 'password','inputCode' ], { force: true }, (err, values) => {
            if (!err) {
              ...
              loginParams.staff_uuid = document.getElementById("socketstr").value;
      ...
      departClear(){
        this.departList=[]
        this.departSelected=""
        this.departIdSelected=""
        this.currentUsername=""
        this.departVisible=false
        this.validate_status=''
      },
      departChange(value, $event){
        this.validate_status='success'
        this.departSelected = value
        this.departIdSelected = $event.key
      },
    getRouterData(){
      this.$nextTick(() => {
