  ...
  export default {
    ...
    data () {
      return {
        data: [
          {
            title: '账户密码', description: '当前密码强度', value: this.userInfo().passwordLevel, actions: {
              title: '修改', callback: () => {
                this.updatePassword();
              }
            }
          ...
          {
            title: '密保手机', description: '已绑定手机', value: '138****8293', actions: {
              title: '修改', callback: () => {
          ...
          {
            title: '备用邮箱', description: '已绑定邮箱', value: 'ant***sign.com', actions: {
              title: '修改', callback: () => {
