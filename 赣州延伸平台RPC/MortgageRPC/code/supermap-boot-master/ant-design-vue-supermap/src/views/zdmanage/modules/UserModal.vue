    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="证件类型" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-select placeholder="请选择证件类型" v-decorator="[ 'zjlx', validatorRules.zjlx]" >
        ...
        <a-form-item label="证件号" :labelCol="labelCol" :wrapperCol="wrapperCol" >
          <a-input placeholder="请输入证件号" v-decorator="[ 'zjh', validatorRules.zjh]" />
        </a-form-item>
    ...
    export default {
      ...
      methods: {
        ...
        edit (record) {
          ...
          that.$nextTick(() => {
            that.form.setFieldsValue(pick(this.model,'username','sex','realname','email','phone','activitiSync','zjlx','zjh'))
          });
          // 调用查询用户对应的部门信息的方法
