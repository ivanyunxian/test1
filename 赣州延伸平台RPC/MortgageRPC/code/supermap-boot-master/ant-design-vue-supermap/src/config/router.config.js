    ...
    children: [
      {
        path: 'apply',
        name: 'apply',
        component: () => import(/* webpackChunkName: "user" */ '@/views/enterprise/register/RegisterEnterprise')
      },
      {
        path: 'list',
        name: 'list',
        component: () => import(/* webpackChunkName: "user" */ '@/views/enterprise/register/EnterpriseList')
      },
    ]
},
