...
//验证企业用户是否存在
const checkOnlyEnterprise = (params)=>getAction("/yspt/enterprise/checkOnlyUser",params);
//改变密码
...
// 查询用户所属部门列表
const queryDepartByUserTreeList = (params)=>getAction("/sysdepart/sysDepart/queryDepartByUserTreeList",params);
//查询宗地树结构
const queryZrzByUserTreeList = (params)=>getAction("/modules/yspt/bdc_zrz/queryZrzByUserTreeList",params);
...
export {
  ...
  queryPermissionRule,
  queryDepartTreeList,
  queryDepartByUserTreeList,
  queryZrzByUserTreeList,
  queryIdTree,
  queryParentName,
  searchByKeywords,
  deleteByDepartId,
