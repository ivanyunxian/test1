 ...
 */
@Entity
@Table(name = "BGQXZDJ", schema = "GXDJK")
public class Bgqxzdj_dj implements java.io.Serializable {
    ...
    public Bgqxzdj_dj(String bsm) {
	this.bsm = bsm;
    }

    public Bgqxzdj_dj(String bsm, String bdcdyh, String ywh, String qlid,
