...
@Repository("baseCommonDaoDJ")
@Transactional
@Scope("prototype")
public class CommonDaoDJ {

	@Autowired
	private SessionFactory sessionFactoryDJ;
	...
	public Session getCurrentSession() {
		session=this.sessionFactoryDJ.openSession();
		return session;
	}
	
	public void SetSessionFlushMede() {
		Session session =sessionFactoryDJ.getCurrentSession();
	...
	public  ResultSet excuteQuery(String sql)
		...
		pstmt = SessionFactoryUtils.getDataSource(this.sessionFactoryDJ).getConnection().prepareStatement(sql);
