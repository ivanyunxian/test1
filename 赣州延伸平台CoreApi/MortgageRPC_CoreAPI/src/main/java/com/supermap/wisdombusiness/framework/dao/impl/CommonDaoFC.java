...
@Repository("baseCommonDaoFC")
@Transactional
@Scope("prototype")
public class CommonDaoFC {

	@Autowired
	private SessionFactory sessionFactoryFC;
	...
	public Session getCurrentSession() {
		session=this.sessionFactoryFC.openSession();
		return session;
	}
	
	public void SetSessionFlushMede() {
		Session session =sessionFactoryFC.getCurrentSession();
	...
	public  ResultSet excuteQuery(String sql)
		...
		pstmt = SessionFactoryUtils.getDataSource(this.sessionFactoryFC).getConnection().prepareStatement(sql);
