 ...
 */
@Entity
@Table(name = "BGQDYAQ", schema = "GXDJK")
public class Bgqdyaq_dj implements java.io.Serializable {
    ...
    public Bgqdyaq_dj(String bsm) {
	this.bsm = bsm;
    }

    public Bgqdyaq_dj(String bsm, String ywh, String bdcdyh, String qlid,
