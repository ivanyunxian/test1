...
import com.supermap.wisdombusiness.framework.model.gxjyk.genrt.GenerateH;

@Entity
@Table(name = "h", schema = "gxjyk")
public class JYH extends GenerateH {
	...
	@Override
	@Column(name = "qsc", length = 100)
	public String getQSC() {
		return super.getQSC();
	}
	@Override
	@Column(name = "zzc", length = 100)
