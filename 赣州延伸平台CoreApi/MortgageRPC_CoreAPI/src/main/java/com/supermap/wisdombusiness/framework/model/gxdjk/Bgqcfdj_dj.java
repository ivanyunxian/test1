 ...
 */
@Entity
@Table(name = "BGQCFDJ", schema = "GXDJK")
public class Bgqcfdj_dj implements java.io.Serializable {
    ...
    public Bgqcfdj_dj(String bsm) {
	this.bsm = bsm;
    }

    public Bgqcfdj_dj(String bsm, String bdcdyh, String ywh, String qlid,
