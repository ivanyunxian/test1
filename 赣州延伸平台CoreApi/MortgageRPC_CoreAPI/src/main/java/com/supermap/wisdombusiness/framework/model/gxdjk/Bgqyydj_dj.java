 ...
 */
@Entity
@Table(name = "BGQYYDJ", schema = "GXDJK", uniqueConstraints = @UniqueConstraint(columnNames = "YSDM"))
public class Bgqyydj_dj implements java.io.Serializable {
    ...
    public Bgqyydj_dj(String bsm) {
	this.bsm = bsm;
    }

    public Bgqyydj_dj(String bsm, String ysdm, String ywh, String bdcdyh,
