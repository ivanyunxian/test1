 ...
 */
@Entity
@Table(name = "BGQYGDJ", schema = "GXDJK")
public class Bgqygdj_dj implements java.io.Serializable {
    ...
    public Bgqygdj_dj(String bsm) {
	this.bsm = bsm;
    }

    public Bgqygdj_dj(String bsm, String ysdm, String ywh, String bdcdyh,
