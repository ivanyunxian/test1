...
import com.supermap.realestate.registration.model.genrt.GenerateDCS_SLLM_GZ;
...
@Entity
@Table(name = "bdcs_sllm_gz", schema = "bdcdck")
public class DCS_SLLM_GZ extends GenerateDCS_SLLM_GZ implements Forest {
