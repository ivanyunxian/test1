...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_C_LSY;
import com.supermap.realestate.registration.model.interfaces.Floor;

@Entity
@Table(name = "bdcs_c_lsy", schema = "bdck")
public class BDCS_C_LSY extends GenerateBDCS_C_LSY implements Floor {
