 ...
 * 
 * 批量单元限制登记
 * @ClassName: DYLimitedDJHandler_PL
 * @author liangc
 * @date 2017年09月18日 上午10:37:40
 */
public class DYLimitedDJHandler_PL extends DJHandlerBase implements DJHandler {
	 ...
	 * @param info
	 */
	public DYLimitedDJHandler_PL(ProjectInfo info) {
		super(info);
	}
