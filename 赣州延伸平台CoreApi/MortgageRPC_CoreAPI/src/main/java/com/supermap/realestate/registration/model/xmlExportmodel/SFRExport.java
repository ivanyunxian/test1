...
@XStreamAlias("SFR")
public class SFRExport {
	@XStreamAsAttribute
	@XStreamOmitField
	@XStreamAlias("name")
	private String NAME = "售房人";
	...
	private PropertyInfo DLJGMC = new PropertyInfo("代理人证件类型名称");
	private PropertyInfo GYQK = new PropertyInfo("代理机构名称");
	private PropertyInfo GYFS = new PropertyInfo("共有情况");
	...
	private PropertyInfo BZ = new PropertyInfo("BZ");
