...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_YHYDZB_LS;
import com.supermap.realestate.registration.model.interfaces.YHYDZB;

@Entity
@Table(name = "bdcs_yhydzb_ls", schema = "bdck")
public class BDCS_YHYDZB_LS extends GenerateBDCS_YHYDZB_LS implements YHYDZB {
