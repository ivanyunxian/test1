...
public interface forestQueryService {

	Message queryForest(Map<String, String> queryvalues, int page, int rows, boolean iflike, String sort, String order);

	@SuppressWarnings("rawtypes")
	List<Map> getForestInfo(String bdcdyid, String bdcdylx);
	...
	@SuppressWarnings("rawtypes")
	List<List<Map>> GetQLList(String ycscbdcdyid);

	QLInfo GetQLInfo(String qlid, String djzt);

	BDCS_DYXZ GetDYXZInfo(String id);
