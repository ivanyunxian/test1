 ...
 * 
* 房屋预查封登记
* @ClassName: YCFDJ_HouseXZHandler 
* @author hmh 
* @date 2018年11月26日11:25:27
 */
public class YCFDJ_HouseXZHandler extends DJHandlerBase implements DJHandler {

	public YCFDJ_HouseXZHandler(ProjectInfo info) {
		super(info);
	}
	...
	private ResultMessage addbdcdy(String bdcdyid) {
		...
		House house = (House) UnitTools.loadUnit(BDCDYLX.H, DJDYLY.XZ,
				bdcdyid);
