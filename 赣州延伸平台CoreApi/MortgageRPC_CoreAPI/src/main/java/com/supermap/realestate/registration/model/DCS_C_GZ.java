...
import com.supermap.realestate.registration.model.genrt.GenerateDCS_C_GZ;
import com.supermap.realestate.registration.model.interfaces.Floor;

@Entity
@Table(name = "bdcs_c_gz", schema = "bdcdck")
public class DCS_C_GZ extends GenerateDCS_C_GZ implements Floor{
