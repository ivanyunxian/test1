...
public class DJFZXX  {
	...
	private String m_ywr;//义务人
	
	private String slsj;//受理时间
	
	private String m_lzrzjh;//领证人证件号
	...
	public String getM_ywr() {
		return m_ywr;
	}

	public void setM_ywr(String m_ywr) {
		this.m_ywr = m_ywr;
	}
	...
	public String getM_lzrzjh() {
		return m_lzrzjh;
	}

	public void setM_lzrzjh(String m_lzrzjh) {
		this.m_lzrzjh = m_lzrzjh;
	}
