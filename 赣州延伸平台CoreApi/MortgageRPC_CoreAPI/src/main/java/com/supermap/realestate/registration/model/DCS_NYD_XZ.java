...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_NYD_XZ;
...
@Entity
@Table(name = "bdcs_nyd_xz", schema = "bdcdck")
public class DCS_NYD_XZ extends GenerateBDCS_NYD_XZ implements AgriculturalLand {
