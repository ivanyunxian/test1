...
import com.supermap.realestate.registration.model.genrt.GenerateDCS_SYQZD_GZ;
...
@Entity
@Table(name = "bdcs_syqzd_gz", schema = "bdcdck")
public class DCS_SYQZD_GZ extends GenerateDCS_SYQZD_GZ implements OwnerLand {
