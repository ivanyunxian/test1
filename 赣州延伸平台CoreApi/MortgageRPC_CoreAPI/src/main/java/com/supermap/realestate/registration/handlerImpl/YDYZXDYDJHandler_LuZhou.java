 ...
 * 
* 预抵押转现房抵押处理类(泸州专用)
* @ClassName: YDYZXDYDJHandler_LuZhou 
* @author 俞学斌 
* @date 2015年11月26日 下午10:49:08
 */
public class YDYZXDYDJHandler_LuZhou extends DYDJHandler {
	 ...
	 * @param info
	 */
	public YDYZXDYDJHandler_LuZhou(ProjectInfo info) {
		super(info);
	}
