...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_SYQZD_XZ;
...
@Entity
@Table(name = "bdcs_syqzd_xz", schema = "bdck")
public class BDCS_SYQZD_XZ extends GenerateBDCS_SYQZD_XZ implements OwnerLand {
