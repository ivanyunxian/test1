...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_SLLM_XZ;
...
@Entity
@Table(name = "bdcs_sllm_xz", schema = "bdck")
public class BDCS_SLLM_XZ extends GenerateBDCS_SLLM_XZ implements Forest {
