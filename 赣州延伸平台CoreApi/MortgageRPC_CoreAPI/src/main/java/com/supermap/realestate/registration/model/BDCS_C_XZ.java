...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_C_XZ;
import com.supermap.realestate.registration.model.interfaces.Floor;

@Entity
@Table(name = "bdcs_c_xz", schema = "bdck")
public class BDCS_C_XZ extends GenerateBDCS_C_XZ implements Floor {
