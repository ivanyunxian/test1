...
public class GenerateDCS_H_GZY implements SuperModel<String> {
	...
	private Byte[] fCFHTWJ;
	private boolean modify_fCFHTWJ = false;

	public Byte[] getFCFHTWJ() {
		return fCFHTWJ;
	}

	public void setFCFHTWJ(Byte[] fCFHTWJ) {
		if (this.fCFHTWJ != fCFHTWJ) {
			this.fCFHTWJ = fCFHTWJ;
			modify_fCFHTWJ = true;
		}
	}
	...
	private Double cRJJE;
	private boolean modify_cRJJE = false;

	public Double getCRJJE() {
		return cRJJE;
	}

	public void setCRJJE(Double cRJJE) {
		if (this.cRJJE != cRJJE) {
			this.cRJJE = cRJJE;
			modify_cRJJE = true;
		}
	...
	private String fCFHTWJLX;
	private boolean modify_fCFHTWJLX = false;

	public String getFCFHTWJLX() {
		return fCFHTWJLX;
	}

	public void setFCFHTWJLX(String fCFHTWJLX) {
		if (this.fCFHTWJLX != fCFHTWJLX) {
			this.fCFHTWJLX = fCFHTWJLX;
			modify_fCFHTWJLX = true;
		}
	}

	private String dCXMBH;
	private boolean modify_dCXMBH = false;

	public String getDCXMBH() {
		return dCXMBH;
	}

	public void setDCXMBH(String dCXMBH) {
		if (this.dCXMBH != dCXMBH) {
			this.dCXMBH = dCXMBH;
			modify_dCXMBH = true;
		}
	}
	...
	public String[] getIgnoreProperties() {
		...
		if (!modify_fCFHTWJLX)
			listStrings.add("fCFHTWJLX");
		if (!modify_dCXMBH)
			listStrings.add("dCXMBH");
		if (!modify_yZB)
			listStrings.add("yZB");
		if (!modify_xZB)
			listStrings.add("xZB");
