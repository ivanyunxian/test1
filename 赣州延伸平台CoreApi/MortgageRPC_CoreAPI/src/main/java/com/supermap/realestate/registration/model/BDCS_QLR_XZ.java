...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_QLR_XZ;
import com.supermap.realestate.registration.model.interfaces.RightsHolder;
import com.supermap.realestate.registration.util.ConstHelper;

@Entity
@Table(name = "bdcs_qlr_xz", schema = "bdck")
public class BDCS_QLR_XZ extends GenerateBDCS_QLR_XZ implements RightsHolder {
	...
	public String getQLRLXName() {
		if (qlrlxname == null) {
			if (this.getQLRLX() != null) {
				qlrlxname = ConstHelper
						.getNameByValue("QLRLX", this.getQLRLX());
			}
		}
		return qlrlxname;
	}
	...
	public String getFDDBRZJLXName() {
		if (fddbrzjlxname == null) {
			if (this.getFDDBRZJLX() != null) {
				fddbrzjlxname = ConstHelper.getNameByValue("ZJLX",
						this.getFDDBRZJLX());
			}
		}
	...
	public String getDLRZJLXName() {
		if (dlrzjlxname == null) {
			if (this.getDLRZJLX() != null) {
				dlrzjlxname = ConstHelper.getNameByValue("ZJLX",
						this.getDLRZJLX());
			}
		}
		return dlrzjlxname;
	...
	public String getNATIONNAME() {
		if (nationname == null) {
			if (this.getDLRZJLX() != null) {
				nationname = ConstHelper.getNameByValue("NATION",
						this.getNATION());
			}
		}
		return nationname;
