...
@XStreamAlias("DZDZW")
public class DZDZWExport {
	@XStreamAsAttribute
	@XStreamOmitField
	@XStreamAlias("name")
	private String NAME = "点状定着物";
	...
	private PropertyInfo DZDZWLX = new PropertyInfo("点状定着物类型");
	...
	public PropertyInfo getDZDZWLX() {
		return DZDZWLX;
	}

	public void setDZDZWLX(Object _Value) {
		DZDZWLX.setvalue(_Value);
	}
