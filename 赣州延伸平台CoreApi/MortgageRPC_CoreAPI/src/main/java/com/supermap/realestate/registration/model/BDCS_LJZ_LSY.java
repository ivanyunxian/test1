...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_LJZ_LSY;
import com.supermap.realestate.registration.model.interfaces.LogicBuilding;

@Entity
@Table(name = "bdcs_ljz_lsy", schema = "bdck")
public class BDCS_LJZ_LSY extends GenerateBDCS_LJZ_LSY implements LogicBuilding{
