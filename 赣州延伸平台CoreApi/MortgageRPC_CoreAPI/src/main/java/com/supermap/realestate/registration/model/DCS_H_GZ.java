...
import com.supermap.realestate.registration.model.genrt.GenerateDCS_H_GZ;
...
@Entity
@Table(name = "bdcs_h_gz", schema = "bdcdck")
public class DCS_H_GZ extends GenerateDCS_H_GZ implements House{
