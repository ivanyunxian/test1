...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_FSQL_LS;
import com.supermap.realestate.registration.model.interfaces.SubRights;
import com.supermap.realestate.registration.util.ConstHelper;

@Entity
@Table(name = "bdcs_fsql_ls", schema = "bdck")
public class BDCS_FSQL_LS extends GenerateBDCS_FSQL_LS implements SubRights {
	...
	private String cflxname;
	@Transient
	public String getCFLXName() {
		if (cflxname == null) {
			if (this.getCFLX() != null) {
				cflxname = ConstHelper.getNameByValue("CFLX", this.getCFLX());
			}
		}
		return cflxname;
	}
	...
	public String getPLAINTIFF() {
		return super.getPLAINTIFF();
	}
	
	@Override
	@Column(name = "defendant")
	public String getDEFENDANT() {
		return super.getDEFENDANT();
	}
	@Override
	@Column(name = "tdpgjz")
	public String getTDPGJZ() {
		return super.getTDPGJZ();
	}
	...
	public Integer getDYDYJXZ() {
		return super.getDYDYJXZ();
	}
	
	@Override
	@Column(name = "fysdsj")
	public Date getFYSDSJ() {
		return super.getFYSDSJ();
	}

	@Override
	public void setFYSDSJ(Date fYSDSJ) {
		super.setFYSDSJ(fYSDSJ);
	}
	
	@Override
	@Column(name = "dgbdbzzqse")
	public Double getDGBDBZZQSE() {
		return super.getDGBDBZZQSE();
	}
	@Override
	public void setDGBDBZZQSE(Double dGBDBZZQSE) {
		 super.setDGBDBZZQSE(dGBDBZZQSE);
	}
	...
	@Column(name = "htsj")
	public Date getHTSJ() {
		return super.getHTSJ();
	}
	@Override
	@Column(name = "basj")
	public Date getBASJ() {
		return super.getBASJ();
	}
	@Column(name = "htcjjg")
	public Double getHTCJJG(Double hTCJJG) {
		return super.getHTCJJG();
	}
	@Override
	@Column(name = "wssj")
	public Date getWSSJ() {
	...
	@Column(name = "wsje")
	public Double getWSJE(Double wSJE) {
