...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_C_LS;
import com.supermap.realestate.registration.model.interfaces.Floor;

@Entity
@Table(name = "bdcs_c_ls", schema = "bdck")
public class BDCS_C_LS extends GenerateBDCS_C_LS  implements Floor{
