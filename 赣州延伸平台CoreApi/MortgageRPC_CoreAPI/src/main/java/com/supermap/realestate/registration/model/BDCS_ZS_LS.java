...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_ZS_LS;
import com.fasterxml.jackson.annotation.JsonProperty;

@Entity
@Table(name = "bdcs_zs_ls", schema = "bdck")
public class BDCS_ZS_LS extends GenerateBDCS_ZS_LS {
