...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_SHYQZD_LS;
...
@Entity
@Table(name = "bdcs_shyqzd_ls", schema = "bdck")
@XStreamAlias("SHYQZD")
public class BDCS_SHYQZD_LS extends GenerateBDCS_SHYQZD_LS implements UseLand {
