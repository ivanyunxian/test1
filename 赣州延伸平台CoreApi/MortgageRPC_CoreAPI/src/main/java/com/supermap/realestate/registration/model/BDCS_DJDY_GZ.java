...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_DJDY_GZ;
import com.supermap.realestate.registration.model.interfaces.RegisterUnit;

@Entity
@Table(name = "bdcs_djdy_gz", schema = "bdck")
public class BDCS_DJDY_GZ extends GenerateBDCS_DJDY_GZ implements RegisterUnit {
