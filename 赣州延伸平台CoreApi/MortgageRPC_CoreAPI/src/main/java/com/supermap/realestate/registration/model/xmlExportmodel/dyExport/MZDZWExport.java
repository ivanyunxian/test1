...
@XStreamAlias("MZDZW")
public class MZDZWExport {
	@XStreamAsAttribute
	@XStreamOmitField
	@XStreamAlias("name")
	private String NAME = "面状定着物";
	...
	private PropertyInfo MZDZWLX = new PropertyInfo("面状定着物类型");
	...
	public PropertyInfo getMZDZWLX() {
		return MZDZWLX;
	}

	public void setMZDZWLX(Object _Value) {
		MZDZWLX.setvalue(_Value);
	}
