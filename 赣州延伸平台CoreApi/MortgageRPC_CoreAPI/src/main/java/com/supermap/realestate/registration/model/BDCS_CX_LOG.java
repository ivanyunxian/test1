...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_CX_LOG;
import com.fasterxml.jackson.annotation.JsonProperty;

@Entity
@Table(name = "bdcs_cx_log", schema = "bdck")
public class BDCS_CX_LOG extends GenerateBDCS_CX_LOG {
