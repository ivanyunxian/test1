...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_SYQZD_GZ;
...
@Entity
@Table(name = "bdcs_syqzd_gz", schema = "bdck")
public class BDCS_SYQZD_GZ extends GenerateBDCS_SYQZD_GZ implements OwnerLand {
