...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_ZS_XZ;
import com.fasterxml.jackson.annotation.JsonProperty;

@Entity
@Table(name = "bdcs_zs_xz", schema = "bdck")
public class BDCS_ZS_XZ extends GenerateBDCS_ZS_XZ {
