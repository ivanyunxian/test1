...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_QZFFKSB;

@Entity
@Table(name = "bdcs_qzffksb", schema = "bdck")
public class BDCS_QZFFKSB extends GenerateBDCS_QZFFKSB {
