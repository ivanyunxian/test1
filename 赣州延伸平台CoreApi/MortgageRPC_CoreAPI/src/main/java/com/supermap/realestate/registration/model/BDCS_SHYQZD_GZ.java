...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_SHYQZD_GZ;
...
@Entity
@Table(name = "bdcs_shyqzd_gz", schema = "bdck")
public class BDCS_SHYQZD_GZ extends GenerateBDCS_SHYQZD_GZ implements UseLand {
