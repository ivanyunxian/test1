...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_YHZK_XZ;
import com.supermap.realestate.registration.model.interfaces.YHZK;
import com.supermap.realestate.registration.util.ConstHelper;

@Entity
@Table(name = "bdcs_yhzk_xz", schema = "bdck")
public class BDCS_YHZK_XZ extends GenerateBDCS_YHZK_XZ implements YHZK {
