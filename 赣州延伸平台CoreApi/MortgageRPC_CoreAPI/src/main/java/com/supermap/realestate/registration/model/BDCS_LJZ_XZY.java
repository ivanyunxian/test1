...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_LJZ_XZY;
import com.supermap.realestate.registration.model.interfaces.LogicBuilding;

@Entity
@Table(name = "bdcs_ljz_xzy", schema = "bdck")
public class BDCS_LJZ_XZY extends GenerateBDCS_LJZ_XZY implements LogicBuilding{
