...
import com.supermap.realestate.registration.model.genrt.GenerateDCS_LJZ_GZY;
import com.supermap.realestate.registration.model.interfaces.LogicBuilding;

@Entity
@Table(name = "bdcs_ljz_gzy", schema = "bdcdck")
public class DCS_LJZ_GZY extends GenerateDCS_LJZ_GZY implements LogicBuilding {
