...
import com.supermap.realestate.registration.model.genrt.GenerateDCS_YHZK_GZ;
import com.supermap.realestate.registration.model.interfaces.YHZK;
import com.supermap.realestate.registration.util.ConstHelper;

@Entity
@Table(name = "bdcs_yhzk_gz", schema = "bdcdck")
public class DCS_YHZK_GZ extends GenerateDCS_YHZK_GZ implements YHZK {
