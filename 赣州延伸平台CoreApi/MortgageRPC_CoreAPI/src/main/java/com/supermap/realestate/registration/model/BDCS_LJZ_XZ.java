...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_LJZ_XZ;
import com.supermap.realestate.registration.model.interfaces.LogicBuilding;

@Entity
@Table(name = "bdcs_ljz_xz", schema = "bdck")
public class BDCS_LJZ_XZ extends GenerateBDCS_LJZ_XZ implements LogicBuilding{
