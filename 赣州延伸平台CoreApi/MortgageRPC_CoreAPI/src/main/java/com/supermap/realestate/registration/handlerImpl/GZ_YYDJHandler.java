...
/*
 1、国有建设用地使用权异议更正登记
 2、集体建设用地使用权异议更正登记（未配置）
 3、宅基地使用权异议更正登记
 4、国有建设用地使用权/房屋所有权异议更正登记
 5、集体建设用地使用权/房屋所有权异议更正登记（未配置）
 6、宅基地使用权/房屋所有权异议更正登记（未配置）
 */
/**
 * 
 * 更正异议登记处理类
 ...
 *
 */
public class GZ_YYDJHandler extends DJHandlerBase implements DJHandler {

	/**
	 * 
	 * @param info
	 */
	public GZ_YYDJHandler(ProjectInfo info) {
		super(info);
	}
