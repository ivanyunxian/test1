...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_ZH_LS;
...
@Entity
@Table(name = "bdcs_zh_ls", schema = "bdck")
public class BDCS_ZH_LS extends GenerateBDCS_ZH_LS implements Sea {
	...
	public String getYHLXAName() {
		if (yhlxaname == null) {
			if (this.getYHLXA() != null) {
				yhlxaname = ConstHelper.getNameByValue("HYSYLXA",
						this.getYHLXA());
			}
		}
		return yhlxaname;
	...
	public String getYHLXBName() {
		if (yhlxbname == null) {
			if (this.getYHLXB() != null) {
				yhlxbname = ConstHelper.getNameByValue("HYSYLXB",
						this.getYHLXB());
			}
		}
		return yhlxbname;
