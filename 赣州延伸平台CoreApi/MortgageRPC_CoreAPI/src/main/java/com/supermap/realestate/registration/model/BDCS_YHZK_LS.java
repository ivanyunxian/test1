...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_YHZK_LS;
import com.supermap.realestate.registration.model.interfaces.YHZK;
import com.supermap.realestate.registration.util.ConstHelper;

@Entity
@Table(name = "bdcs_yhzk_ls", schema = "bdck")
public class BDCS_YHZK_LS extends GenerateBDCS_YHZK_LS implements YHZK {
