...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_QDZR_GZ;
import com.supermap.realestate.registration.model.interfaces.RightsRelation;

@Entity
@Table(name = "bdcs_qdzr_gz", schema = "bdck")
public class BDCS_QDZR_GZ extends GenerateBDCS_QDZR_GZ implements RightsRelation {
