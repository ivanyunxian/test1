...
public class GenerateBDCS_ZRZ_XZ implements SuperModel<String> {
	 ...
	 * ����Ȼ����������һ����ݳ�ȡ��ʶ��
	 */
	private String FDCSJCQBS;
	private boolean modify_SJCQBS = false;

	public String getFDCSJCQBS() {
		return FDCSJCQBS;
	}
	public void setFDCSJCQBS(String FDCSJCQBS){
		if (this.FDCSJCQBS != FDCSJCQBS) {
			this.FDCSJCQBS = FDCSJCQBS;
			modify_SJCQBS = true;
		}
	}
