...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_SLLM_LS;
...
@Entity
@Table(name = "bdcs_sllm_ls", schema = "bdck")
public class BDCS_SLLM_LS extends GenerateBDCS_SLLM_LS implements Forest {
