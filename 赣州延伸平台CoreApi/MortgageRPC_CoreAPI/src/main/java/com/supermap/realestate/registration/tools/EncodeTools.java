...
public class EncodeTools {
	...
	//二维码加密密钥
	private static  final String   MY="5ecf7669c60d4e25865f1847c321129a20190523";
	...
	public static String encoderByDES(String plainText) {
		try {
			byte[] result = coderByDES(plainText.getBytes("UTF-8"), MY,
					Cipher.ENCRYPT_MODE);
	 ...
	 * @return
	 */
	public static String decoderByDES(String secretText) {
		try {
			byte[] result = coderByDES(hexStr2ByteArr(secretText), MY,
					Cipher.DECRYPT_MODE);
