...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_NYD_LS;
...
@Entity
@Table(name = "bdcs_nyd_ls", schema = "bdcdck")
public class DCS_NYD_LS extends GenerateBDCS_NYD_LS implements AgriculturalLand {
