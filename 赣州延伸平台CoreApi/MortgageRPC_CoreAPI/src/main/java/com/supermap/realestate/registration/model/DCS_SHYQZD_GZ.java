...
import com.supermap.realestate.registration.model.genrt.GenerateDCS_SHYQZD_GZ;
...
@Entity
@Table(name = "bdcs_shyqzd_gz", schema = "bdcdck")
public class DCS_SHYQZD_GZ extends GenerateDCS_SHYQZD_GZ implements UseLand {
	...
	private String bgztname;

	@Transient
	public String getBGZTName() {
		if (bgztname == null) {
			if (this.getBGZT() != null) {
				bgztname = ConstHelper.getNameByValue("BGZT", this.getBGZT());
			}
		}
		return bgztname;
	}
