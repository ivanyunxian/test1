...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_LJZ_LS;
import com.supermap.realestate.registration.model.interfaces.LogicBuilding;

@Entity
@Table(name = "bdcs_ljz_ls", schema = "bdck")
public class BDCS_LJZ_LS extends GenerateBDCS_LJZ_LS implements LogicBuilding{
