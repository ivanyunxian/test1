...
public class FDCQ1 {
	...
	private String TDSYQSSJ;// 土地使用其实时间
	private String TDSYJSSJ;// 土地使用结束时间
	private String FDCJYJG;// 房地产交易价格
	private String BDCQZH;// 不动产单元号
	private String FJ;// 附记
	private String FCFHT;// 分层分户图
	private String QSZT;// 权属状态
	private String QSZTMC;// 权属状态名称
	private String XMMC;// 房地产权（项目内多幢）项目信息--;
	private String ZH;// 幢号
	private String ZCS;// 总层数
	private String GHYT;// 规划用途
	private String GHYTMC;//规划用途名称
