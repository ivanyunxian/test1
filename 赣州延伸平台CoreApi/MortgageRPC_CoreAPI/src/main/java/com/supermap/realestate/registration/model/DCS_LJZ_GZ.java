...
import com.supermap.realestate.registration.model.genrt.GenerateDCS_LJZ_GZ;
import com.supermap.realestate.registration.model.interfaces.LogicBuilding;

@Entity
@Table(name = "bdcs_ljz_gz", schema = "bdcdck")
public class DCS_LJZ_GZ extends GenerateDCS_LJZ_GZ implements LogicBuilding {
