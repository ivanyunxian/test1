...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_YHYDZB_GZ;
import com.supermap.realestate.registration.model.interfaces.YHYDZB;

@Entity
@Table(name = "bdcs_yhydzb_gz", schema = "bdck")
public class BDCS_YHYDZB_GZ extends GenerateBDCS_YHYDZB_GZ implements YHYDZB {
