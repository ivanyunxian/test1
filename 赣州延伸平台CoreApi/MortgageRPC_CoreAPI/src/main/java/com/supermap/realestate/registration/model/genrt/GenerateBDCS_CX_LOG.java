...
public class GenerateBDCS_CX_LOG implements SuperModel<String> {
	...
	public void setXMBH(String xMXX) {
		if (this.xMBH != xMXX) {
			this.xMBH = xMXX;
			modify_xMBH = true;
		}
	...
	private String lSH;
	private boolean modify_lSH = false;
