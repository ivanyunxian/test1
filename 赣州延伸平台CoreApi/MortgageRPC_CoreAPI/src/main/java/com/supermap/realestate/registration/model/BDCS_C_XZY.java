...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_C_XZY;
import com.supermap.realestate.registration.model.interfaces.Floor;

@Entity
@Table(name = "bdcs_c_xzy", schema = "bdck")
public class BDCS_C_XZY extends GenerateBDCS_C_XZY implements Floor {
