...
import com.supermap.realestate.registration.model.genrt.GenerateRT_CONSTRAINT;

@Entity
@Table(name = "rt_constraint", schema = "bdck")
public class RT_CONSTRAINT extends GenerateRT_CONSTRAINT  implements RTCONSTRAINT {
