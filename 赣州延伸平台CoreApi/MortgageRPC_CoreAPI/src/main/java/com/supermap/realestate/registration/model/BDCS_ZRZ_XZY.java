...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_ZRZ_XZY;
...
@Entity
@Table(name = "bdcs_zrz_xzy", schema = "bdck")
public class BDCS_ZRZ_XZY extends GenerateBDCS_ZRZ_XZY   implements Building{
