 ...
 * 转移登记+抵押权变更登记操作类
 * 
 * @ClassName: ZY_DYQBG_DJHandler
 * @author heks
 * @date 2017年04月26日 上午午09:46:00
 */
/**
 ...
 *
 */
public class ZY_DYQBG_DJHandler extends DJHandlerBase implements DJHandler {
	 ...
	 * @param info
	 */
	public ZY_DYQBG_DJHandler(ProjectInfo info) {
		super(info);
	}
	...
	protected void CopyQLXXFromYDY(String qlid, BDCS_DJDY_GZ djdy, String sfnewcqr) {
		...
		if (bdcs_ql_xz != null) {
			...
			bdcs_ql_gz.setDJLX("300");// 重置登记类型---抵押权变更，直接给变更登记
