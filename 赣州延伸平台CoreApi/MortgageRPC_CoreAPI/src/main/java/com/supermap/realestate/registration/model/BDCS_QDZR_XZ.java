...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_QDZR_XZ;
import com.supermap.realestate.registration.model.interfaces.RightsRelation;

@Entity
@Table(name = "bdcs_qdzr_xz", schema = "bdck")
public class BDCS_QDZR_XZ extends GenerateBDCS_QDZR_XZ implements RightsRelation{
