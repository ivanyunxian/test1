...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_ZH_GZ;
...
@Entity
@Table(name = "bdcs_zh_gz", schema = "bdck")
public class BDCS_ZH_GZ extends GenerateBDCS_ZH_GZ implements Sea {
