...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_ZH_XZ;
...
@Entity
@Table(name = "bdcs_zh_xz", schema = "bdck")
public class BDCS_ZH_XZ extends GenerateBDCS_ZH_XZ implements Sea {
