...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_SYQZD_LS;
...
@Entity
@Table(name = "bdcs_syqzd_ls", schema = "bdck")
public class BDCS_SYQZD_LS extends GenerateBDCS_SYQZD_LS implements OwnerLand {
