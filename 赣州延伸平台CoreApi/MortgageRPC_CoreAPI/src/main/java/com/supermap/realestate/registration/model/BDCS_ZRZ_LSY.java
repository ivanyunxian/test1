...
import com.supermap.realestate.registration.model.genrt.GenerateBDCS_ZRZ_LSY;
...
@Entity
@Table(name = "bdcs_zrz_lsy", schema = "bdck")
public class BDCS_ZRZ_LSY extends GenerateBDCS_ZRZ_LSY   implements Building{
