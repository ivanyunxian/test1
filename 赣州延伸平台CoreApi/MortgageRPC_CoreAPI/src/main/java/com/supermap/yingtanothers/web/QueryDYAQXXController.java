 ...
 * 
 * 作者： 苗利涛
 * 时间： 2016年1月18日 下午5:28:57
 * 功能：鹰潭市不动产查询抵押权信息
 */

@Controller
@RequestMapping("/querydyaqxx")
public class QueryDYAQXXController {

	@Autowired
	private QueryDYAQXXService q_QueryDYAQXXService;

	@RequestMapping(value = "/querydyaqxxlist/", method = RequestMethod.GET)
	public @ResponseBody Message QueryQlxxInfo(HttpServletRequest request,
		...
		m = q_QueryDYAQXXService.QueryDyaqxxInfoByGXXMBH(sqrxm, bdcdyh, gxxmbh, page, rows);
